...
namespace BitPool.Cryptography.MACs.BLAKE2B
{
	public sealed partial class Blake2BCore
	{
		// Loop-unrolled and de-index-accessed version - original state variable and helper functions shown below
		...
		*/
		...
		partial void Compress(byte[] block, int start)
		{
			...
			var v14 = IV6 ^ this._finalizationFlag0;
			var v15 = IV7 ^ this._finalizationFlag1;
